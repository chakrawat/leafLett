let mapInitializedw = false;
function showMapttp() {
	if (mapInitializedw) return; // If map is already initialized, do nothing
    
    mapInitializedw= true;
    // แสดงแผนที่
    ...
    var mapElementp = document.getElementById("map");
		...
		var taxiIcon = L.icon({
			iconUrl: 'https://cdn-icons-png.flaticon.com/128/8701/8701366.png',
			iconSize: [80, 80]
		})
		...
		// สิ้นสุดป้าย
			...
			L.Routing.control({
				...
				createMarker: function(i, waypoint, n) {
					...
					var markerNames = [
						'มศว',
						'ตรงข้ามศูนย์การประชุมแห่งชาติสิริกิติ์,8บาท',
						'ตลาดคลองเตย (ฝั่งรัชดาภิเษก),8บาท',
						'อู่คลองเตย,8บาท'
